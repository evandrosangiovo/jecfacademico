...
/**
*  Bematech.java
*  Está classe é responsável pelo mapeamento dos comandos contidos na DLL (BemaFI32.dll)
*  Classe utilizada para compatibilidade com a dll BemaFI32.dll com java
**/
public class Bematech {
	...
	public static native int AcrescimoDescontoItemMFD(String item, String acrescimoDesconto, String tipoAcrescimoDesconto, String valorAcrescimoDesconto);
	public static native int AcrescimoDescontoSubtotalRecebimentoMFD(String flag, String tipo, String valor);
	public static native int AcrescimoDescontoSubtotalMFD(String flag, String tipo, String valor);
	...
	public static native int EfetuaFormaPagamentoMFD(String formaPagamento, String valorFormaPagamento, String cParcelas, String descricaoFormaPagto);
	...
	public static native int ImprimeChequeMFD(String numeroBanco, String valor, String favorecido, String cidade, String data, String msg, String impressaoVerso, String linhas);
	...
	public static native int IniciaFechamentoCupomMFD(String acrescimoDesconto, String tipoAcrescimoDesconto, String valorAcrescimo, String valorDesconto);
	public static native int IniciaFechamentoRecebimentoNaoFiscalMFD(String acrescimoDesconto, String tipoAcrescimoDesconto, String valorAcrescimo, String valorDesconto);
	...
	static{
            Main m = new Main();
            //System.load(m.getApplicationPath() + "/bemajava/BemaFI32.DLL");
